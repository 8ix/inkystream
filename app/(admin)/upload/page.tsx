      ...
      <div className="ink-card p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 text-sm">
          ...
          <div className="p-4 rounded-xl bg-black/20 border border-white/10">
            ...
            <p className="font-medium text-white mb-1">We handle the processing</p>
            <p className="text-white/50">InkyStream applies a neutral pipeline optimised for e-ink</p>
          </div>
          <div className="p-4 rounded-xl bg-black/20 border border-white/10">
